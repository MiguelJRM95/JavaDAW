...
public class PuntoEspacio{
	...
	//Metodo para calcular distancia al origen con sobrecarga de metodos
	...
	public double calcularDistancia(PuntoEspacio otroPunto){

		return Math.sqrt(Math.pow((this.puntoX - otroPunto.getX()), 2) + Math.pow((this.puntoY - otroPunto.getY()), 2));
	...
	public static void main(String[] args) {
		...
		System.out.println("Distancia de origen al (8,20): " + dec2Res.format(punto2.calcularDistancia()));

		//Calcular distancia pasando otro punto
		System.out.println("Distancia al (-3,-4) desde el nuevo punto (3, 4): " + puntoSimetrico.calcularDistancia(new PuntoEspacio(3, 4)));
		System.out.println("Distancia al punto 1 (1, 5) desde el nuevo punto (3, 4): " + dec2Res.format(punto1.calcularDistancia(new PuntoEspacio(3, 4))));
	}
}